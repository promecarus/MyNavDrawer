package com.promecarus.mynavdrawer
...
import com.promecarus.mynavdrawer.ui.theme.MyNavDrawerTheme
...
fun MyNavDrawerApp() {
    ...
    Scaffold(
        ...
        ModalNavigationDrawer(modifier = Modifier.padding(paddingValues),
